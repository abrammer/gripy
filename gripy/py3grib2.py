...
lat/lon values returned by grid method may be incorrect."""
            ...
            raise NotImplementedError('PyProj not replaced yet')
...
def Grib2Decode(filename,gribmsg=False):
 ...
 with one element.
    ...
    for n in range(nmsg):
        ...
        idsect,pos = g2pylib.unpack1(gribmsg,lensect0) # python version
        ...
        while 1:
            ...
            # section 3, grid definition section.
                ...
                gds,gdtempl,deflist,pos = g2pylib.unpack3(gribmsg,pos,np.empty)
            ...
            # section, product definition section.
                ...
                pdtempl,pdtn,coordlst,pos = g2pylib.unpack4(gribmsg,pos,np.empty)
                pdtmpls.append(pdtempl)
                coordlists.append(coordlst)
                pdtnums.append(pdtn)
            # section 5, data representation section.
            elif sectnum == 5:
                drtempl,drtn,npts,pos = g2pylib.unpack5(gribmsg,pos,np.empty)
                drtmpls.append(drtempl)
                drtnums.append(drtn)
                ndptslist.append(npts)
            # section 6, bit-map section.
            elif sectnum == 6:
                bmap, bmapflag = g2pylib.unpack6(gribmsg,gds[1],pos,np.empty)
